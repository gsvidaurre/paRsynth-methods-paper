...
# Were any SPCC values found to be negative?
# Were there any values of 1 off of the diagonal in the SPCC matrices?
# unique(res$notes)

# There are no notes about any issues found in the SPCC matrices. All notes are about replacing values of 1 off of the diagonal in the edit distance matrix, looks good
