...
CODE REVIEW COMPLETED BY SUMMER ECKHARDT
________________________________________
...
git_path <- "/Users/summe/OneDrive/Desktop/github_repo/paRsynth-methods-paper/figures"
###################################################################################

```

TODO: I think this part might need to be reworked a bit to match the 'Initializing working directories' chunks from the other RMD files in this manuscript. I believe the 'Create the data directory if it doesn't already exist on your computer' step should be occurring multiple times / needs to happen after every new directory is established. Because these directories don't already exist on my computer, I am getting warnings here & cannot proceed past this point unless I manually add these folders to my desktop / within the analysis dir
```{r}
...
TODO: LINE 188: dataframe reads "datframe" here (I would change it but I am not sure I am allowed to change code in this round of code review?).

TODO: the final line of the chunk below only reads as "Looks good" - I think it would be good to explain what you are checking for here
...
TODO: Line 262 wany -> want && funtion -> function

TODO: Line 279 ngreay -> ngrey
...
prop_labs <- c("Proportion of n group information: 0", "0.33", "0.67", "1")
names(prop_labs) <- unique(res$group_information_proportion)

# Make object ngreay, to set as strip background color. 
...
TODO: Line 389, you only state the results of the Shapiro test, but don't have actual test coded
```{r}
...
TODO: Line 475 capalized -> capitalized
```{r}
