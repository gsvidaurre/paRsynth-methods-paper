...
Below we iterate over dataset sizes (simulating less or more crowded signaling environments) and group versus individual information encoding in character strings that we expect to influence the distinctiveness or uniqueness synthetic vocalizations at either social level. 
...
# TKTK Need to finalize lead coder review!!!
...
# Load the bipartite mapping function in a separate chunk because RMarkdown knitting continues to fail with the source call() above.
