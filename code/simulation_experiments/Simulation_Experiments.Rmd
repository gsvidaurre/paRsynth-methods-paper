...
TODO: Remove packages that are no longer necessary (mclust?)
...
X <- c("devtools", "dplyr", "stringdist", "tidyverse", "ggplot2", "soundgen", "parallel", "stringr", "data.table", "tuneR", "pbapply", "Rmisc", "warbleR", "stringdist", "combinat")
...
source(file.path(path, "github_repo/paRsynth-methods-paper/code/functions/accuracy_score.R"))
...
# Load custom functions for the code below
# This line of code loads a function to calculate the maximum global accuracy of clustering by finding and calculating accuracy across all bipartite matchings (matchings between original class labels and predicted cluster labels)
# source("/Users/gsvidaurre/Desktop/GitHub_repos/paRsynth-methods-paper/code/functions/accuracy_score.R")
source("/Users/summe/OneDrive/Desktop/github_repo/paRsynth-methods-paper/code/functions/accuracy_score.R")
...
repo_path <- "/Users/summe/OneDrive/Desktop/github_repo/paRsynth/R/"
