...
Below we iterate over dataset sizes (simulating less or more crowded signaling environents) and group versus individual information encoding in character strings that we expect to influence the distinctiveness or uniqueness synthetic vocalizations at either social level. 
...
# Simulation experiments over varying social environment characteristics and information encoding rules
