...
# No change to f0 width: vocalTract, rolloff
soundgen(
...
soundgen(
  sylLen = 4000, # TKTK add specific guidelines for duration based on character string or freqency anchor length, see below
