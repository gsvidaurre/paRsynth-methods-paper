...
lexicon_path <- "C:/Users/britt/Desktop/paRsynth_methods_synthetic_dataset/audio/LexiconFigureFiles" #Brittany's path
...
lapply(X = 1:length(lexicon_wavs), FUN = function (w){
  
  # read in the audio file, return a wave object
  temp_wav <- tuneR::readWave(file.path(lexicon_path, lexicon_wavs{w}))
  #sstr(tmp_wav)
  
  # use ggspectro to generate a spectrogram
  # TKTK need to mess with setting, the spectrograms look funky
  gg <- ggspectro(wave = tmp_wav, f = tmp_wav@sample.rate, ovlp = 90) +
