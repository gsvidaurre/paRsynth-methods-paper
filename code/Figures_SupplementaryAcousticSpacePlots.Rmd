...
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_GroupMembership_GroupPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_GroupMembership_GroupPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_GroupMembership_IndividualPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_GroupMembership_IndividualPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_IndividualIdentity_IndividualPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_IndividualIdentity_IndividualPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_IndividualIdentity_GroupPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_IndividualIdentity_GroupPolygons.tiff"), width = 3.75, height = 4, units = "in", dpi = 300)
