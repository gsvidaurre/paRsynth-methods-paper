...
These eight image files should be used to generate 2 supplementary figures: One showing patterns of variation in acoustic space for the group membership dataset across (dis)similarity methods and polygons at either social level, and a similar figure for the individual identity dataset.
...
To generate a legend of the correct size for a composite figure, you can write out one large image file for each composite figure that is sized correctly for the legend, then crop the figure to include the legend only. You should also check that the legends all match across panels per figure before cropping out these legends per panel.
...
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_GroupMembership_GroupPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
...
mds_spcc_grp %>%
  ...
  # Uncomment this line to turn off the legend
   guides(color = "none", shape = "none", fill = "none") +
  # Specify the x and y-axis limits and breaks. Make sure that each label retains two decimal places even when there is a trailing zero
  scale_x_continuous(limits = c(-0.3, -0.02), breaks = seq(-0.3, -0.02, 0.05), labels = sprintf("%.2f", round(seq(-0.3, -0.02, 0.05), 2))) +
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_GroupMembership_GroupPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_GroupMembership_IndividualPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_GroupMembership_IndividualPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_IndividualIdentity_IndividualPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_IndividualIdentity_IndividualPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_edit_IndividualIdentity_GroupPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
...
# Save this plot as an image file
# This image size (and font sizes or other aesthetics above) should be iteratively updated to fit a composite figure of multiple acoustic space plots created in other software
ggsave(filename = file.path(figures_path, "Suppl_AcousticSpace_SPCC_IndividualIdentity_GroupPolygons.tiff"), width = 3.535, height = 3.771, units = "in", dpi = 300)
