...
z <- 2 # number of groups and individuals, or social conditions, as well as the number of calls per individual
  ...
  invisible(pblapply(1:length(N), function(z){
    ...
    lapply(1:length(group_information), function(i){
      ...
      res_tmp <- data.table::rbindlist(lapply(1:iteratns, function(n){
        ...
        # # TKTK consider removing this given new balanced sampling scheme above
