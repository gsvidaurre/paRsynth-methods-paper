...
# All shapes by individual within groups
...
ggsave(filename = file.path(figures_path, "Main_AcousticSpace_edit_GroupMembership_GroupPolygons_Legend.tiff"), width = 8, height = 4, units = "in", dpi = 300)
...
# This is the image size that will be written to create a legend for the composite figure created in other software
ggsave(filename = file.path(figures_path, "Main_AcousticSpace_SPCC_GroupMembership_GroupPolygons_Legend.tiff"), width = 8, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
ggsave(filename = file.path(figures_path, "AcousticSpace_edit_IndividualIdentity_IndividualPolygons_Legend.tiff"), width = 8, height = 4, units = "in", dpi = 300)
...
# Save this plot as an image file
ggsave(filename = file.path(figures_path, "AcousticSpace_SPCC_IndividualIdentity_IndividualPolygons_Legend.tiff"), width = 6, height = 4, units = "in", dpi = 300)
