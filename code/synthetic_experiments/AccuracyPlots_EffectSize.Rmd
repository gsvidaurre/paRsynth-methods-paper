...
TKTK cacluating effect size and plotting accuracy and density plots. 

Purpose: The following code was designed to vizualize the accuracy of SPCC and Edit distance calculations across the various experimental treatments. 
  First, the code creates a figure (TKTK figure XX in manuscript) that vizualizs accuracy scores. This figure uses output from the script TKTK "Synthetic_Experiments"to create a data frame which is used to create plots of average accuracy for SPCC and Edit methods by Group Info Proportion and Social Environment Treatments. Plots are separate for information level (group or individual).
  ...
  Third this code creates density plots.  
