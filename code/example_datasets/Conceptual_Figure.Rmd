...
X <- c("devtools", "dplyr", "tidyverse", "data.table", "gganimate", "tuneR")
...
# Read in the audio file, return a wave object
  ...
  gg <- ggspectro(wave = tmp_wav, f = tmp_wav@samp.rate, ovlp = 90) +
    ...
    theme(
      ...
      # Uncomment next line to turn off the axis titles, which should remove titles for all 3 axes, including amplitude and the amplitude scale bar
  ...
  ggsave(filename = file.path(figure_path, "GroupMembership_Group1_Indiv1_Call1.tiff"), units = "in", width = 6.57, height = 3, dpi = 600)
```
