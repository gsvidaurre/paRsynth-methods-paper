---
title: "Conceptual Frequency Anchors Figure and Spectrogram Image"
author: Grace Smith-Vidaurre, Brittany Coppinger, Summer Eckhardt
output: html_document
date: "`r format(Sys.time(), '%d %B, %Y')`"
---

Purpose: This script uses data from the synthetic call metadata to create a conceptual graphic of frequency anchors over time to represent step 3 in the psRsynth pipeline. This graphic is then imported to Inkscape to create part of Figure 1. This code also creates a spectrogram of the resulting synthetic vocalization from the selected character string. This spectrograms is also used in Figure 1. 
...
# git_path <- "/Users/gracesmith-vidaurre/Desktop/GitHub_repos/paRsynth-methods-paper/figures"
