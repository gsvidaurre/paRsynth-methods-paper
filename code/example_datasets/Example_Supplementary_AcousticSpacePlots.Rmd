...
Code review completed by Raneem Samman
...
git_path <- file.path("/Users/raneemsamman/Documents/GitHub") # Raneem's path
...
TODO: are the glimpse stataements not commented on purpose?
...
```
TODO: Cannot find directory /Users/raneemsamman/Documents/GitHub/paRsynth-methods-paper/figures/supplementary_figures/Fig_S1.
...
not sure if this is on purpose or not. Once I selected 1 (yes) to that question, it outputted "✔ Created directory: /Users/raneemsamman/Documents/GitHub/paRsynth-methods-paper/figures/supplementary_figures/Fig_S1." which was a more compact image of the figure created above this chunk.
...
```
TODO: same comment as above. "Cannot find directory /Users/raneemsamman/Documents/GitHub/paRsynth-methods-paper/figures/supplementary_figures/Fig_S2.
ℹ Would you like to create a new directory?
1: Yes
2: No

Selection:"
"✔ Created directory: /Users/raneemsamman/Documents/GitHub/paRsynth-methods-paper/figures/supplementary_figures/Fig_S2."
...
TODO: are the variable names and glimpse stataements not commented on purpose?
```{r}
