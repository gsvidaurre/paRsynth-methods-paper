...
git_path <- file.path("/Users/raneemsamman/Documents/GitHub/paRsynth-methods-paper/figures") # Raneem's path
...
TODO: Error in loadNamespace(x) : there is no package called ‘magick’. I think we need to add this package to the list of packages in line 60. 
TODO: Error in file(con, "wb") : cannot open the connection. I believe this has to do with the git_path but i am not sure what is the correct one here; i tried the following paths: 
git_path <- file.path("/Users/raneemsamman/Documents/GitHub")
git_path <- file.path("/Users/raneemsamman/Documents/GitHub/paRsynth-methods-paper")
git_path <- file.path("/Users/raneemsamman/Documents/GitHub/paRsynth-methods-paper/figures")
...
TODO: Error in file(con, "wb") : cannot open the connection. same error as above chunk
```{r eval=FALSE}
