...
Color Palette should be paletteer ("nationalparkcolors::Arches"): 6 colors with the hex codes: #A8CDECFF #F6955EFF #682C37FF #9B6981FF #7887A4FF #A89F8EFF 

Add colors by group, and hues within colors indicate individual. 

##Step 6.1: Creating colored boarders for the group information dataset. 
```{r}
...
# Set Group 1 individuals to the first color or cols[1] and Group 2 individuals to the second color or cols[2]. Hues per individual within a group should be set using the scales::alpha() function. This vector of colors is a different object than the list above, here there is 1 color specified per individual
...
##Step 6.2: Creating colored boarders for the individual identity dataset. 
```{r}
