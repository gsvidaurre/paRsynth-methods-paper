...
TODO: I have mentioned before about including a more standard approach to labeling paths that need to be editted by each user.
...
git_path <- "/Users/gretheljuarez/Desktop/BIRDS/GitHub_repos/" # Ale's path
...
synthetic_call_metadata <- read.csv("/Users/gretheljuarez/Desktop/paRsynth_methods_synthetic_dataset/synthetic_call_metadata.csv")
glimpse(synthetic_call_metadata)

mds_coords <- read.csv("/Users/gretheljuarez/Desktop/paRsynth_methods_synthetic_dataset/MDS_coordinates.csv")
glimpse(mds_coords)
