...
Code review completed by Grethel Alexandra Juarez.
...
TODO: Would it be more professional if the paths were labeled as an example path and included one without specific names of the user? Line 99-100.
...
path <- "/Users/gretheljuarez/Desktop/" # Ale's path
...
repo_path <- "/Users/gretheljuarez/Desktop/BIRDS/GitHub_repos/paRsynth/R/" # Ale's path
...
TODO: Would it be redundant to mention that although a seed is set, this would generate the same dataset for a specific user not across users? What is the purpose of line 184-186?
...
TODO: Here again, I am confused why lines 287-291 are included with 294-295?
