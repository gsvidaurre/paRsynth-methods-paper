...
X <- c("devtools", "dplyr", "tidyverse", "data.table")
...
freq_anchors %>% 
  ...
  geom_point(size = 3, color = scales::alpha("navy", 0.9)) +
  geom_line(color = scales::alpha("navy", 0.5), linetype = "dotted", linewidth = 1) +
  xlab("Time (s)") +
  ylab("Frequency (kHz)") +
  theme_bw() +
  theme(
...
ggsave(file.path(figure_path, "conceputalFigure_frequencyAnchorsLine.png"), units = "in", width = 5, height = 3, dpi = 300)
