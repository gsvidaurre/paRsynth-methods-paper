...
Freq_anch_plot <-  ggplot(freq_anchors, aes(x = time, y = freq_anchors/1000)) +
  ...
  geom_line(color = scales::alpha("grey52"), linetype = "dotted", linewidth = 2) +
  ...
  geom_point(size = 3.5, color = scales::alpha("black")) +
  xlab("Time (s)") +
  ylab("Frequency (kHz)") +
...
ggsave(file.path(figure_path, "Concept_FreqAnch.tiff"), units = "in", width = 4, height = 2.5, dpi = 600)
