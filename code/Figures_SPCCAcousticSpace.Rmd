...
# Check for values of 0 off of the diagonal...and there are zeroes off of the diagonal, so I need to remove some comparisons, and will also need to remove the same comparisons from the cross-correlation matrix. 
...
- Melt the edit distance matrix and find the call comparisons with values of 0 off of the diagonal
- Melt the SPCC matrix too
- Remove those call comparisons from both melted matrices
- Rebuild the matrices
- Then proceed with MDS acoustic space
