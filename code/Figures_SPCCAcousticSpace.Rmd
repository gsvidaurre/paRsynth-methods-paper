...
# Check for values of 0 off of the diagonal. This will happen by chance when the exact same strings are generated within an individual (even with the random variation).
...
Create a plot of both datasets with group-level polygons, this will be a supplementary figure.
```{r}
