...
You can run the chunks in this script in order, although SPCC may take a while on your local computer. Alternaively, you cn skip Step 2 and read in an SPCC matrix after downloading it from the same shared location where audio files are held.
